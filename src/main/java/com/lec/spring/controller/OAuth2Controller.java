...
import com.lec.spring.domain.oauth.KakaoOAtuthToken;
...
public class OAuth2Controller {
    ...
    public KakaoOAtuthToken kakaoAccessToken(String code){
        ...
        //Json -> Java Object
        ObjectMapper mapper = new ObjectMapper();
        KakaoOAtuthToken token = null;

        try {
            token = mapper.readValue(response.getBody(), KakaoOAtuthToken.class);
            //AccessToken 확인
